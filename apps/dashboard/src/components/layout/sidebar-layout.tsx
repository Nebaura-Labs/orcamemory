      ...
      <Sidebar collapsible="icon">
        <SidebarHeader className="border-b border-sidebar-border/60 px-2 py-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-semibold uppercase tracking-[0.35em] text-sidebar-foreground/80">
              Orca Memory
            </span>
          </div>
        </SidebarHeader>
              ...
              <SidebarMenu>
                {PRIMARY_NAV.map((item, index) => (
                  <SidebarMenuItem key={item.label}>
                    <SidebarMenuButton
                      aria-current={activeGroups.primary[index] ? "page" : undefined}
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                {SECONDARY_NAV.map((item, index) => (
                  <SidebarMenuItem key={item.label}>
                    <SidebarMenuButton
                      aria-current={activeGroups.secondary[index] ? "page" : undefined}
                      disabled={item.disabled}
        ...
        <SidebarFooter className="mt-auto border-t border-sidebar-border/60">
          <Button
            className="w-full border border-dashed border-sidebar-border/60"
            variant="outline"
